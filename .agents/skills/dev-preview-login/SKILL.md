...
description: How to log into the Supercoach dev server for testing. Use this skill whenever you need to preview, test, or interact with the app in a local dev browser — including preview_* tools, Codex Preview, or any localhost:3000 access. Always use this instead of attempting Google popup login, Firebase service account setup, or any other login method.
---
