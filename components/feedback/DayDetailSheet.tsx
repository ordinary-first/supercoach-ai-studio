  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-end justify-center">
      ...
      <div className="relative w-full max-w-lg bg-th-elevated rounded-t-3xl max-h-[85vh] flex flex-col animate-slide-up shadow-2xl border-t border-th-border/50">
        ...
        {/* Content */}
        <div className="flex-1 overflow-y-auto px-5" style={{ paddingBottom: 'calc(80px + env(safe-area-inset-bottom, 0px))' }}>
          {noData ? (
        ...
        {/* Save Button */}
        {isEditing && (
          <div className="px-5 pt-2" style={{ paddingBottom: 'calc(76px + env(safe-area-inset-bottom, 0px))' }}>
            <button
              onClick={handleSave}
