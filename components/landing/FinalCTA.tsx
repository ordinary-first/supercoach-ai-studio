  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`relative z-10 flex flex-col items-center text-center gap-6 max-w-3xl mx-auto transition-all duration-700 ease-out ${
      ...
      >
        ...
        <div className="flex flex-col items-center gap-3 mt-2">
          <button
            onClick={onCTAClick}
            className="uppercase tracking-widest font-black text-lg py-5 px-12 rounded-full text-black transition-all duration-200 hover:scale-105"
            style={{
