  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto">
        {/* Headline */}
        <div
          className={`text-center mb-5 md:mb-16 transition-all duration-700 ease-out ${
        ...
        <div className="flex flex-col md:flex-row gap-2 md:gap-6">
          {PROBLEMS.map((problem, i) => (
            <div
              key={problem.title}
              className={`flex-1 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl md:rounded-3xl p-3 md:p-6 transition-all duration-700 ease-out ${
                isVisible
            ...
            >
              {/* Icon */}
              <div
                className="inline-flex items-center justify-center w-8 h-8 md:w-14 md:h-14 rounded-lg md:rounded-2xl mb-2 md:mb-4"
