---
name: research
description: X/웹에서 현재 작업 관련 최신 정보를 검색하고 .claude/knowledge/expert-tips.md에 기록. 주제를 인자로 전달.
---
...
`.claude/knowledge/expert-tips.md`를 읽어서 이 주제에 대해 이미 알고 있는 것 확인.
...
- `"[주제] site:x.com tips"`
- `"[주제] Claude Code / AI agent workflow"`
- 주제에 맞는 추가 쿼리
