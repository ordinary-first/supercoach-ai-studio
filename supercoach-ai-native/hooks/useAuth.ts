...
import type { GoalLink, GoalNode, ToDoItem, TodoGroup, TodoList, UserProfile } from '../shared/types';
import {
  ensureCreatedAt,
  getSyncStatus,
  getUserId,
        ...
        if (savedProfile) {
          ...
          setUserProfile((prev) => {
            ...
            return {
              ...
              billingSubscriptionId: savedProfile.billingSubscriptionId,
              billingCancelAtPeriodEnd: savedProfile.billingCancelAtPeriodEnd,
